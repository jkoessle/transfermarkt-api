class Players:
    ...
    class Profile:
        ...
        NAME_IN_HOME_COUNTRY = "//span[text()='Name im Heimatland:']//following::span[1]//text()"
        FULL_NAME = "//span[text()='Full name:']//following::span[1]//text()"
        DATE_OF_BIRTH_AGE = "//span[@itemprop='birthDate']//text()"
        PLACE_OF_BIRTH_CITY = "//span[contains(text(),'Geburtsort')]//following::span[1]//text()"
        PLACE_OF_BIRTH_COUNTRY = "//span[contains(text(),'Geburtsort')]//following::span[1]//img//@title"
        HEIGHT = "//span[text()='Größe:']//following::span[1]//text()"
        CITIZENSHIP = "//span[text()='Staatsbürgerschaft:']//following::span[1]//text()"
        POSITION = "//span[text()='Position:']//following::span[1]//text()"
        POSITION_MAIN = "//dt[contains(text(),'Hauptposition:')]//following::dd[1]//text()"
        POSITION_OTHER = "//dt[contains(text(),'Nebenposition:')]//following::dd//text()"
        FOOT = "//span[text()='Fuß:']//following::span[1]//text()"
    ...
    class Transfers:
        YOUTH_CLUBS = (
            "//div[@class='box tm-player-additional-data'][descendant::*[contains(text(), 'Jugendvereine')]]"
...
class Clubs:
    class Profile:
        ...
        NAME = "//header//h1//text()"
        NAME_OFFICIAL = "//th[text()='Offizieller Vereinsname:']//following::td[1]//text()"
        IMAGE = "//div[@class='datenfakten-wappen']//@src"
        # LEGAL_FORM = "//th[text()='Rechtsform:']//following::td[1]//text()"
        # ADDRESS_LINE_1 = "//th[text()='Anschrift:']//following::td[1]//text()"
        # ADDRESS_LINE_2 = "//th[text()='Anschrift:']//following::td[2]//text()"
        # ADDRESS_LINE_3 = "//th[text()='Anschrift:']//following::td[3]//text()"
        # TEL = "//th[text()='Tel:']//following::td[1]//text()"
        # FAX = "//th[text()='Fax:']//following::td[1]//text()"
        # WEBSITE = "//th[text()='Homepage:']//following::td[1]//text()"
        # FOUNDED_ON = "//th[text()='Gründung:']//following::td[1]//text()"
        # MEMBERS = "//th[text()='Mitglieder:']//following::td[1]//text()"
        # MEMBERS_DATE = "//th[text()='Mitglieder:']//following::td[1]//span//text()"
        # OTHER_SPORTS = "//th[text()='Weitere Sportarten:']//following::td[1]//text()"
